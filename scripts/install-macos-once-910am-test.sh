...
CONFIG_PATH="$PROJECT_DIR/config.910am-test-once.json"
...
cp "$SOURCE_DIR"/config.*.json "$RUNTIME_DIR"/
chmod +x "$RUNNER"
...
install_job "claude-910am-test-once" "com.local.cli-heartbeat-scheduler.claude-910am-test-once"
install_job "codex-910am-test-once" "com.local.cli-heartbeat-scheduler.codex-910am-test-once"

echo "scheduled one-shot test jobs for the next 09:10 local time"
